 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Tue Mar 12 10:47:17 2019
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME sfunc_encoder
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS            4
/* Input Port  0 */
#define IN_PORT_0_NAME        pinA
...
/* Input Port  3 */
#define IN_PORT_3_NAME        sampletime
...
extern void sfunc_encoder_Outputs_wrapper(const uint8_T *pinA,
			const uint8_T *pinB,
			...
			real_T *rpm,
			const real_T *xD);
extern void sfunc_encoder_Update_wrapper(const uint8_T *pinA,
			const uint8_T *pinB,
			const uint32_T *cntperrot,
			const uint16_T *sampletime,
			int16_T *pos,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const uint32_T *cntperrot = (uint32_T *) ssGetInputPortRealSignal(S, 2);
    ...
    sfunc_encoder_Outputs_wrapper(pinA, pinB, cntperrot, sampletime, pos, rpm, xD);
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
    ...
    sfunc_encoder_Update_wrapper(pinA, pinB, cntperrot, sampletime, pos, rpm, xD);
