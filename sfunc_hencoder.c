...
#define S_FUNCTION_NAME sfunc_hencoder
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    sfunc_hencoder_Outputs_wrapper(pinA, pinB, cntperrot, sampletime, pos, rpm, xD);
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
    ...
    sfunc_hencoder_Update_wrapper(pinA, pinB, cntperrot, sampletime, pos, rpm, xD);
